---
title: "Capstone: Memory Group Analysis"
...
```{r}
#load data
df = read.csv("Memory Project_November 1, 2021_10.46.csv", header = T)
df = read.csv("Memory Project_November 11, 2021_16.19.csv", header = T) #Prelim Data
